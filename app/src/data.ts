...
export const PROMPTS: Prompts = {
  ...
  "no-rta": {
    "id": "no-rta",
    "promptText": "If you are not covered by the RTA you will find it hard (but not impossible) to fight back. The following organizations may be able to assist you.",
    "choices": [
      {
        "choiceText": "BC Access Pro Bono",
        "linkOut": "https://accessprobono.ca/get-legal-help"
      },
      {
        "choiceText": "Community Legal Assistance Society ",
        "linkOut": "https://clasbc.net/get-legal-help/losing-your-housing/"
      }
    ]
  },
  "written-notice": {
  ...
  "defend-yourself": {
    "id": "defend-yourself",
    "promptText": "If you think you have a case to dispute your eviction or your landlord's claims, you'll need to file a dispute with the Residential Tenancy Branch.",
    "choices": [
      {
        "choiceText": "Know Your Right",
        "linksTo": "self-defence"
      },
      {
        "choiceText": "Find an Advocate",
        "linksTo": "find-an-advocate"
      }
    ]
  },
  "evidence": {
    ...
    "choices": [
      {
        "choiceText": "Yes, I have documentation and/or a willing witness that can provide a statement to support my version of events.",
        "linksTo": "defend-yourself"
      },
      {
        "choiceText": "No",
        "linksTo": "self-defence"
    ...
    "choices": [
      {
        ...
        "linkOut": "https://www.vancouvertenantsunion.ca/eviction_defense_handbook"
      }
    ]
  },
  "get-landlord-info": {
    ...
    "choices": [
      {
        ...
        "linkOut": "https://www.vancouvertenantsunion.ca/advocate_directory"
      }
    ]
  },
  "contact-the-vtu": {
  ...
  "missed-contestation-window": {
    ...
    "promptText": "It seems like you probably missed the window to contest your eviction. To be sure, you could try contacting a legal advocate and/or reading about your rights.",
    "choices": [
      {
        "choiceText": "Know Your Rights",
        "linksTo": "self-defence"
      },
      {
        "choiceText": "Find an Advocate",
      ...
      {
        "choiceText": "Please take some time to report your landlord here.",
        "linkOut": "https://www.vancouvertenantsunion.ca/evictions"
      }
    ]
  },
  "todo": {
