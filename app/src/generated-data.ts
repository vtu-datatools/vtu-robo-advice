...
export const PROMPTS: Prompts = {
    ...
    "missed-contestation-window": {
        ...
        "prompt": "It seems like you probably missed the window to contest your eviction. To be sure, you could try contacting a legal advocate and/or reading about your rights.",
        "choices": [
            {
    ...
    "10-days-to-move-out": {
        ...
        "explainer": {
            "text": "Evictions for unpaid rent or utilities requires 10 days of notice.",
            "link": "https://www2.gov.bc.ca/gov/content/housing-tenancy/residential-tenancies/ending-a-tenancy/landlord-notice"
        },
        "choices": [
            {
    ...
    "chance-to-address": {
        ...
        "prompt": "Did your landlord give you a chance to address the issue?",
        "choices": [
            {
                "choice": "Yes",
                "link": {
    ...
    "written-notice": {
        ...
        "explainer": {
            "text": "Your landlord is required by law to issue you a written eviction notice. Without written notice you eviction is not lawful. Please keep all copies of correspondences with your landlord and try and have a witness present whenever you interact with your landlord.",
    ...
    "30-days-notice": {
        ...
        "explainer": {
            "text": "For cause' evictions usually require 1 month of notice. ",
    ...
    "formal-warning": {
        "id": "formal-warning",
        "prompt": "Did your landlord ever give you a formal warning?",
        "choices": [
            {
                "choice": "Yes",
                "link": {
    ...
    "specific-cause": {
        "id": "specific-cause",
        "prompt": "Did your landlord indicate what specifically you did wrong?",
        "choices": [
            {
                "choice": "Yes",
                "link": {
                    "internal": "chance-to-address"
                }
            },
            {
                "choice": "No",
                "link": {
                    "internal": "formal-warning"
                }
            }
        ]
    },
